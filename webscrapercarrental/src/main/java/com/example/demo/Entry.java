...
//            if locations are different
            ...
            do {
                ...
                @SuppressWarnings("deprecation")
				Date date2 = new Date(return_Date);
                if (date1.compareTo(date2) > 0) {
                	System.out.println("return date should be same date or after date but can not be previous date");
                	System.out.print("Enter return date (DD/MM/YYYY): "); 
                	return_Date = scanner.nextLine();
...
//            System.out.println("Do you have a specific time in mind to pick and return the car: ");
            ...
            do {
                ...
                String rk=pickup_Time.split(" ")[0];
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm").ofPattern("H:mm");

                // Parse the string with the custom formatter
                LocalTime time1 = LocalTime.parse(rk, formatter);
				...
				if(date1.compareTo(date2)==0 )
				{
                int comparisonResult = time1.compareTo(currentTime);
            ...
            String return_Time;
            do {
                System.out.println("Enter return time (HH:MM AM/PM): ");
                return_Time = scanner.nextLine();
                String r1=return_Time.split(" ")[0];
                String r2=pickup_Time.split(" ")[0];
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm").ofPattern("H:mm");
                LocalTime time1 = LocalTime.parse(r1, formatter);
                LocalTime time2 = LocalTime.parse(r2, formatter);
